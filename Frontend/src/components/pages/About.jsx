...
export default function About() {
  return (
    <div className="w-full h-fit py-10 pt-40 md:pt-10 overflow-x-hidden">
      <h1 className="mont text-center text-[var(--blue)] font-black text-[28px] pb-7">What can i do</h1>
      ...
      <div className="pt-20 flex flex-col justify-center items-center">
          ...
          <img src="/profile.png" alt="Profile"  className="__profile__ rounded-full border-6 border-[var(--bg)] w-60 h-60 md:w-70 md:h-70" />
        </div>

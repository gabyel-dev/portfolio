...
export default function About() {
  return (
    <div className="__about__ w-full h-fit py-10 pt-40 md:pt-10 overflow-x-hidden">
      <h1 className="mont text-center text-[var(--blue)] font-black text-[28px] pb-10">What I can do</h1>
      <div className="flex flex-col items-center justify-center gap-4 md:flex md:flex-row md:flex-wrap lg:flex-nowrap md:gap-[3vw] lg:justify-between pb-6">
        ...
        {/* techstack */}
        <div className="__skills__ flex flex-col pt-220 md:pt-120">
          <h1 className="mont text-center text-[var(--blue)] font-black text-[28px] pb-10 md:pb-20">My Skillsets</h1>

          <div className="flex justify-between md:justify-between lg:gap-[10vw]">
